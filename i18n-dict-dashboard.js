...
window.__TFH_I18N_PARTIALS__.fr = Object.assign(window.__TFH_I18N_PARTIALS__.fr || {}, {
  ...
  "dash.setup_pid_label": "Public ID OpenFront — lien ou ID (8 caractères)",
  "dash.setup_pid_ph": "Ex: HabCsQYR",
  "dash.setup_pid_hint": "Sur OpenFront : Paramètres → Public ID → copiez le lien ou le message « Mon Public ID : … » et collez-le ici — l'ID est extrait automatiquement.",
  ...
  "dash.toast_pid_len": "Public ID invalide — 8 caractères alphanumériques (ex: HabCsQYR), ou collez directement le lien OpenFront.",
...
window.__TFH_I18N_PARTIALS__.en = Object.assign(window.__TFH_I18N_PARTIALS__.en || {}, {
  ...
  "dash.setup_pid_label": "OpenFront Public ID — link or ID (8 characters)",
  "dash.setup_pid_ph": "e.g. HabCsQYR",
  "dash.setup_pid_hint": "On OpenFront: Settings → Public ID — copy the link or the “My Public ID: …” message and paste it here — the ID is extracted automatically.",
  ...
  "dash.toast_pid_len": "Invalid Public ID — 8 alphanumeric characters (e.g. HabCsQYR), or paste the OpenFront link directly.",
